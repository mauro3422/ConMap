/**
 * TOPIC: Ciudadanía y Gobierno Digital
 * Materia: Formación Ética y Ciudadana
 * Versión: 18.1 — Guardado: 2026-04-22
 * 
 * Para cargar este tema:
 *   Reemplazar el <script src="js/data.js"> en index.html por
...
window.mapData = {
  ...
  nodes: [
    // ROOT
    { 
      id: 'root', title: 'Ciudadanía y', context: 'Gobierno Digital', 
    ...
    { 
      id: 'd1', title: 'Ciudadanía Digital', context: 'Comunidad virtual',
      details: 'Nuevas formas de participación en red',
      level: 1, parentId: 'root', theme: 'teal', status: 'pending'
    },
    { 
      id: 'd1_origin', title: 'Surge por', context: 'Internet y TIC',
      details: 'Tecnologías de la Información y la Comunicación',
      level: 2, parentId: 'd1', theme: 'teal', status: 'pending'
    },
    { 
      id: 'd1_allows', title: 'Permite', context: 'Acciones en línea',
      lines: ['Buscar información', 'Comunicarse y opinar', 'Participar en línea', 'Realizar trámites'],
      level: 2, parentId: 'd1', theme: 'teal', status: 'pending'
    },
    { 
      id: 'd1_limits', title: 'Límites', context: 'Restricciones importantes',
      lines: ['No hay autoridad digital universal', 'No hay régimen político común', 'No reemplaza la ciudadanía estatal'],
      level: 2, parentId: 'd1', theme: 'teal', type: 'warning', status: 'critical'
    },
    { 
      id: 'd1_conclusion', title: 'Conclusión', context: 'Alcance real',
      details: 'Práctica social, no ciudadanía jurídica plena',
      level: 3, parentId: 'd1_limits', theme: 'teal', type: 'note', status: 'pending'
    },

    // RAMA 3 — GOBIERNO DIGITAL (green)
    { 
      id: 'g1', title: 'Gobierno Digital', context: 'Estado y TIC',
      details: 'Uso de tecnología en la gestión pública',
      level: 1, parentId: 'root', theme: 'green', status: 'pending'
    },
    { 
      id: 'g1_def', title: 'Definición', context: '¿Qué es?',
      details: 'Uso de TIC por parte del Estado para gestionar',
      level: 2, parentId: 'g1', theme: 'green', type: 'definition', status: 'pending'
    },
    { 
      id: 'g1_functions', title: 'Funciones', context: 'Para qué sirve',
      lines: ['Mejorar servicios públicos', 'Facilitar trámites', 'Aumentar transparencia', 'Fomentar participación ciudadana', 'Mejorar comunicación Estado-ciudadano'],
      level: 2, parentId: 'g1', theme: 'green', status: 'pending'
    },
    { 
      id: 'g1_goal', title: 'Objetivo Central', context: 'Meta principal',
      details: 'Acercar el Estado a la ciudadanía',
      level: 2, parentId: 'g1', theme: 'green', type: 'key', status: 'pending'
    }
  ],
